...
export default [
    createGetRoute("/admin/course/filter_data",
        {
    ...
    createPatchRoute("/admin/course/:_id/set_active",
        {
            authorized_permissions: [pAdmin.course.setActive],
            validators: [
                validate_request('_id', { isMongoId: true }, CheckType.param),
                validate_request("status", {isNumeric: true}).isIn([EnumConstant.ACTIVE, EnumConstant.DISABLED]),
            ]   
        }, async (req) => {
            return controllers.course.setActive(req);
        }
    ),
    createPatchRoute("/admin/course/:_id/archive",
        {
            authorized_permissions: [pAdmin.course.setActive],
            validators: [
                validate_request('_id', { isMongoId: true }, CheckType.param),
                validate_request("archive", {isNumeric: true}).isIn([EnumConstant.ACTIVE, EnumConstant.INACTIVE]),
            ]   
        }, async (req) => {
            return controllers.course.setArchive(req);
        }
    ),
    createPatchRoute("/admin/course/:_id",
        {
            authorized_permissions: [pAdmin.course.write],
            validators: [
                validate_request('_id', { isMongoId: true }, CheckType.param),
    ...
    createGetRoute("/admin/course/:_id/student",
        {
            authorized_permissions: [pAdmin.course.read],
            validators: [
                validate_request('_id', { isMongoId: true }, CheckType.param),
    ...
    createGetRoute("/admin/course/:_id",
        {
            authorized_permissions: [pAdmin.course.read],
            validators: [
                validate_request('_id', { isMongoId: true }, CheckType.param),
    ...
    createDeleteRoute("/admin/course/:_id", {
