...
export default [
    createGetRoute("/admin/report_data/approved_list/filter_data",
        {
    ...
    createGetRoute("/admin/report_data/approved_list",
        {
            authorized_permissions: [pAdmin.report.studentList],
            validators: [
    ...
    createGetRoute("/admin/report_data/filter_data",
        {
    ...
    createGetRoute("/admin/report_data/student_apply_count",
        {
            ...
            validators: [
                ...
                validate_request("shifts", { optional: true ,isMongoId: true }, CheckType.query),
            ]
        }, async (req) => {
            return controllers.reportData.studentApplyBySchool(req);
        }
    ),
    createGetRoute("/admin/report_data/student_apply_by_major",
        {
            authorized_permissions: [pAdmin.report.adminDataStudentApply],
            validators: [
                validate_request("start_date", {exist: true}, CheckType.query),
    ...
    createGetRoute("/admin/report_data/student_apply_city_province",
        {
            authorized_permissions: [pAdmin.report.adminDataStudentApply],
            validators: [
                validate_request("start_date", {exist: true}, CheckType.query),
    ...
    createGetRoute("/admin/report_data/approval_student_count",
        {
    ...
    createGetRoute("/admin/report_data/approval_student_by_major",
        {
            authorized_permissions: [pAdmin.report.adminDataApprovedCount],
            validators: [
                validate_request("start_date", {exist: true}, CheckType.query),
    ...
    createGetRoute("/admin/report_data/approval_student_city_province",
        {
            authorized_permissions: [pAdmin.report.adminDataApprovedCount],
            validators: [
                validate_request("start_date", {exist: true}, CheckType.query),
    ...
    createGetRoute("/admin/report_data/study_status/filter_data",
        {
            authorized_permissions: [pAdmin.report.adminDataStudentApply, pAdmin.report.adminDataApprovedCount ],
        }, async (req) => {
    ...
    createGetRoute("/admin/report_data/study_status_by_school",
        {
            authorized_permissions: [pAdmin.report.adminDataApprovedCount],
            validators: [
                // validate_request("start_date", {exist: true}, CheckType.query),
                ...
                validate_request("apply_majors", { optional: true ,isMongoId: true }, CheckType.query),
                validate_request("shifts", { optional: true, isMongoId: true }, CheckType.query),
                validate_request("poor_status", { optional: true ,isNumeric: true }, CheckType.query).isIn([EnumConstant.ACTIVE]),
            ]
        }, async (req) => {
            return controllers.reportData.studentStudyStatusBySchool(req);
        }
    ),
    createGetRoute("/admin/report_data/study_status_by_major",
        {
            authorized_permissions: [pAdmin.report.adminDataApprovedCount],
            validators: [
                // validate_request("start_date", {exist: true}, CheckType.query),
